<?php
    ...
    if(isset($_POST["sei"])){
        ...
        if(strpos($sei,',') !== false){
            $sei = str_replace(',','&cma;',$sei);
        }
        if(strpos($sei,'<') !== false){
            $sei = str_replace('<','&lst;',$sei);
            $sei = str_replace('>','&gst;',$sei);
        }
    }else{
        $sei="";
        $flg=1;
    ...
    if(isset($_POST["mei"])){
        ...
        if(strpos($mei,',') !== false){
            $mei = str_replace(',','&cma;',$mei);
        }
        if(strpos($mei,'<') !== false){
            $mei = str_replace('<','&lst;',$mei);
            $mei = str_replace('>','&gst;',$mei);
        }
    }else{
        $mei="";
        $flg=1;
    ...
    if(isset($_POST["place"])){
        ...
        if(strpos($place,',') !== false){
            $place = str_replace(',','&cma;',$place);
        }
        if(strpos($place,'<') !== false){
            $place = str_replace('<','&lst;',$place);
            $place = str_replace('>','&gst;',$place);
        }
    }else{
        $place="";
        $flg=3;
    ...
    if($category=="未選択"){
        //カテゴリが何も選択されてなくてもなんか入ってたら「その他」カテゴリ扱いにしてます。
